...
class ArtistDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    context
        .read<PlayListBloc>()
        .add(RequestArtistsDetailEvent(artistId: artiestId));
    return Scaffold(
    ...
    return BlocBuilder<PlayListBloc, PlayListState>(
      ...
      builder: (context, state) {
        ...
        if (state is RequestArtiestDetailSuccess) {
          return _buildArtistDetailContent(state, context);
        }
  ...
  Expanded _buildArtistDetailContent(
      RequestArtiestDetailSuccess state, BuildContext context) {
    return Expanded(
      child: Padding(
